...
//                	var $div = $('<div></div>').hide().appendTo("body").html(html);
//                	var innerData = $div.find("#main").html();
//                	alert('innerData='+innerData);
                	//var h = html.replace(new RegExp('script', 'g'),'_s_gh');
                	var h1 = html.replace(new RegExp('<script', 'g'),'<_s_gh');
                	var h2 = h1.replace(new RegExp('</script>', 'g'),'<_e_gh>');
                	//alert('h2='+h2);
                	var _hh = $("#main", $(h2)).html();
                	//alert('_hh='+_hh);
                	var _hhh = _hh.replace(new RegExp("&lt;_s_gh&gt;", 'g'),"<script>").replace(new RegExp("&lt;_e_gh&gt;", 'g'),"</script>").replace(new RegExp("&lt;", 'g'),"<").replace(new RegExp("&gt;",'g'),">").replace(new RegExp("_s_gh","g"),"script");
                	//alert('_hhh='+_hhh);
//                	var aaaaa = $("#main", h).html();
//                    alert('aaaaa='+aaaaa);
//                    var bb = aaaaa.replace(new RegExp("&lt;_s_gh&gt;", 'g'),"<script>").replace(new RegExp("<!--_s_gh-->",'g'),"</script>").replace(new RegExp("</_S_GH>",'g'),"</script>");
                    //alert("bb="+bb);
                    html='<div id="main">'+_hhh+'</div>';
